    ...
    public function bed_list($id = null) {
        ...
        if (!empty($result)) {
            foreach ($result as $key => $value) {
                if ($value["pid"] != null) {
                    if (($value['patient_status'] == 'yes') && ($value['ipd_discharged'] != 'yes')) {
                        $data[] = $value;

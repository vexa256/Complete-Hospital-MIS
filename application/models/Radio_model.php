...
class Radio_model extends CI_Model {
    ...
    public function getBillDetails($id) {
        $this->db->select('radiology_report.*,radio.test_name,radio.short_name,radio.report_days,patients.patient_name,staff.name as doctor_name');
        ...
        $this->db->join('staff', 'staff.id = radiology_report.consultant_doctor');

...
class Patient_model extends CI_Model {
    ...
    public function deletePatient($id) {
        ...
        $query = $this->db->where("id", $id)->delete("patients");
    }

...
class Pathology_model extends CI_Model {
    ...
    public function getBillDetails($id) {
        $this->db->select('pathology_report.*,pathology.test_name,pathology.short_name,pathology.report_days,patients.patient_name,staff.name as doctor_name');
        ...
        $this->db->join('staff', 'staff.id = pathology_report.consultant_doctor');

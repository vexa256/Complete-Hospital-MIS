            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon"> 
                    <div id='edit_delete'>
                        ...
                        if ($this->rbac->hasPrivilege('birth_record', 'can_edit')) {
                            ?>
                            <a href="#"  data-target="#edit_birth"  data-toggle="modal" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                            <?php
                        }
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('print_death_report', 'can_view')) { ?><a href='#' data-toggle='tooltip' onclick='printData(" + id + ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a> <?php } ?><?php if ($this->rbac->hasPrivilege('pharmacy bill', 'can_edit')) { ?><a href='#'' onclick='getRecord(" + id + ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('pharmacy bill', 'can_edit')) { ?><a onclick='delete_bill(" + id + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
                if (data.document) {
                    $('#download_document').html("<?php if ($this->rbac->hasPrivilege('pharmacy bill', 'can_edit')) { ?><a href='<?php echo base_url(); ?>admin/birthordeath/download/" + downloadid + "' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('download'); ?>'><i class='fa fa-download'></i></a><?php } ?>");
                }
            },
        });
    }

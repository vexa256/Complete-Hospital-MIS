            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon"> 
                    <div id='edit_delete'>
                        ...
                        if ($this->rbac->hasPrivilege('death_record', 'can_edit')) {
                            ?>
                            <a href="#"  data-target="#edit_death"  data-toggle="modal" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                            <?php
                        };
                        ?>

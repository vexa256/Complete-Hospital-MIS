                                                        ...
                                                        <div class="rowoptionview"> 
                                                            ...
                                                            if ($student['is_ipd'] != 'yes') {
                                                                ...
                                                                <!--<div class="btn-group" style="margin-left:2px;">
                                                                        ...
                                                                        <a href="<?php echo site_url('admin/staff/create'); ?>" style="border-radius:2px 0px 0px 2px" class="btn btn-primary btn-sm"><?php echo $this->lang->line('add_staff'); ?>
                                                                        </a>
...
<script type="text/javascript">
    ...
    function printVisitBill(patientid = '') {

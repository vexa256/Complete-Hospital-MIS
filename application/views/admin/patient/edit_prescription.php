    ...
    <?php } ?>
                                            <!-- <input type="text" class="form-control" value="<?php //echo $value['dosage']   ?>" name="dosage[]" id="report_document" /> -->
                                                <select   class="form-control select2" style="width: 100%"  name="dosage[]" id="editsearch-dosage<?php echo $i ?>">
                                                   ...
                                                   <!-- <select class="form-control" name="dosage[]" id="editsearch-dosage<?php echo $i ?>" >
                                                           <option value=""><?php echo $this->lang->line('select') ?></option>
                                                <?php foreach ($dosage as $key => $dosagevalue) {
                                                    ?>
                                                                    <option value="<?php echo $dosagevalue['dosage'] ?>" <?php
                                                    if ($dosagevalue['dosage'] == $value['dosage']) {
                                                        echo "selected";
                                                    }
                                                    ?>><?php echo $dosagevalue['dosage'] ?></option>
    <?php } ?>
                                                    </select>-->
                                            </div> 
                                        </div>

            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('ot') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></h3>
                        <?php if (empty($printing_list)) { ?>
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('print_ot_record', 'can_add')) { ?>
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('ot') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></div>
                                        ...
                                        foreach ($printing_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('print_ot_record', 'can_edit')) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('print_ot_record', 'can_delete')) { ?>
                        ...
                        <div class="row" id="edit_bedtypedata">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  name="setting_for" placeholder="" value="ot" type="hidden" class="form-control"   />
                                    <span class="text-danger name"></span>
                                </div>
                            </div>
                        </div>

    ...
    <ul class="tablists">
        ...
        <li>
            ...
            if ($this->rbac->hasPrivilege('print_payslip_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/payslipprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/payslipprinting'); ?>"><?php echo $this->lang->line('payslip'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('birth_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/birthprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/birthprinting'); ?>"><?php echo $this->lang->line('birth_record'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('death_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/deathprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/deathprinting'); ?>"><?php echo $this->lang->line('death_record'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('pathology_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/pathologyprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/pathologyprinting'); ?>"><?php echo $this->lang->line('pathology'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('radiology_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/radiologyprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/radiologyprinting'); ?>"><?php echo $this->lang->line('radiology'); ?></a>
            <?php } ?></li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('ot_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/otprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/otprinting'); ?>"><?php echo $this->lang->line('operation_theatre'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('bloodbank_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/bloodbankprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/bloodbankprinting'); ?>"><?php echo $this->lang->line('blood_bank'); ?></a>
            <?php } ?>
        </li>
        <li>
            <?php
            if ($this->rbac->hasPrivilege('ambulance_print_header_footer', 'can_view')) {
                ?>
                <a href="<?php echo site_url('admin/printing/ambulanceprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/ambulanceprinting'); ?>"><?php echo $this->lang->line('ambulance'); ?></a>
            <?php } ?>
        </li>
    </ul>
</div>

                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($resultlist as $pharmacy) {
                                    ...
                                    <tr class="">
                                        <td >
                                            <?php if ($this->rbac->hasPrivilege('purchase', 'can_view')) { ?>   
                                    ...
                                    <div class="">
                                        <table class="table table-striped table-bordered table-hover" id="tableID">
                                            <tr>
                                                ...
                                                <th style="width: 110px"><?php echo $this->lang->line('packing') . " " . $this->lang->line('qty'); ?><small class="req" style="color:red;"> *</small></th>
            ...
            function edit_bill(id, purchase_no, supplier_id) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#editsupplier').val(supplier_id);
                        $('#purchaseno').val(purchase_no);

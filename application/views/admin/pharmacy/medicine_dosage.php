                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('medicine_dosage', 'can_delete')) {
                                                        ?>
                                                        <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="" onclick="delete_recordById('<?php echo base_url(); ?>admin/medicinedosage/delete/<?php echo $dosage['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('medicine') . " " . $this->lang->line('dosage'); ?></h4> 
            </div>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            ...
                            <input autofocus="" name="dosage" placeholder="" type="text" class="form-control"  value="<?php
                            if (isset($result)) {
                                echo $result["dosage"];
                            }
                            ?>" />
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('dosage'); ?></label>
                            <small class="req"> *</small>
                            <input autofocus="" name="dosage" id="dosage" placeholder="" type="text" class="form-control"  value="<?php
                            if (isset($result)) {
                                echo $result["dosage"];
                            }
                            ?>" />

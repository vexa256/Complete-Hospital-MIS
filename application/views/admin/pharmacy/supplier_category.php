...
?>      -->
            <?php $this->load->view('admin/pharmacy/_pharmacyMasters') ?>
                            ...
                            <table class="table table-striped table-bordered table-hover example" >
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('supplier') . " " . $this->lang->line('contact'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('medicine_supplier', 'can_delete')) {
                                                    ?>
                                                    <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="" onclick="delete_recordById('<?php echo base_url(); ?>admin/medicinecategory/deletesupplier/<?php echo $supplier['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('supplier'); ?></h4> 
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier') . " " . $this->lang->line('name'); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier') . " " . $this->lang->line('contact'); ?></label>
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('edit') . " " . $this->lang->line('supplier'); ?></h4> 
            </div>
                ...
                <div class="modal-body pt0 pb0">
                    ...
                    <div class="row ptt10">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier') . " " . $this->lang->line('name') ?></label><small class="req"> *</small>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('contact'); ?></label>
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#id').val(result.id);
                $('#supplier_category').val(result.supplier_category);

                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if ($this->rbac->hasPrivilege('import_medicine', 'can_add')) { ?>                
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" required id="medicine_category_id" name="medicine_category_id" class="form-control" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div><input required class="filestyle form-control" type='file' name='file' id="file" size='20' />

                            ...
                            <tbody>
                                ...
                                if (empty($resultlist)) {
                                    ...
                                    foreach ($resultlist as $pharmacy) {
                                        $quantity = $pharmacy['total_qty'];
                                        $min_level = $pharmacy['min_level'];
                                        $reorder_level = $pharmacy['reorder_level'];
                                        $color = " ";
                                        $status = "";
                                        if ($quantity <= 0) {
                                            $color = "danger";
                                            $status = " (" . $this->lang->line('out_of_stock') . ")";
                                        } elseif ($quantity <= $min_level) {
                                            $color = "warning";
                                            $status = " (" . $this->lang->line('low_stock') . ")";
                                        ...
                                        <tr class="<?php echo $color ?>">
                                            <td>
                                                <?php if ($this->rbac->hasPrivilege('medicine', 'can_view')) { ?>  
                                                    <?php echo $pharmacy['medicine_name']; ?>
                                                <?php } ?>
                                                <div class="rowoptionview">
                                                    <!--  <?php if ($this->rbac->hasPrivilege('add_medicine_stock', 'can_add')) { ?>  
                                                                  <a href="#" onclick="addBulk('<?php echo $pharmacy['id'] ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('add') . ' ' . $this->lang->line('stock'); ?>">
                                                                      <i class="fa fa-plus-square" aria-hidden="true"></i>
                                                                  </a>
                                                    <?php } ?>-->
                                                    <?php if ($this->rbac->hasPrivilege('medicine', 'can_view')) { ?>  
                                                        <a href="#" 
                                                           onclick="viewDetail('<?php echo $pharmacy['id'] ?>')"
                                                           class="btn btn-default btn-xs"  data-toggle="tooltip"
                                                           title="<?php echo $this->lang->line('show'); ?>" >
                                                            <i class="fa fa-reorder"></i>
                                                        </a> 
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('medicine_bad_stock', 'can_add')) { ?>
                                                        <a href="#" class="btn btn-default btn-xs" onclick="addbadstock('<?php echo $pharmacy['id'] ?>')" data-toggle="tooltip"
                                                           title="<?php echo $this->lang->line('add') . " " . $this->lang->line('bad') . " " . $this->lang->line('stock'); ?>" >
                                                            <i class="fas fa-minus-square"></i>
                                                        </a> 
                                                    <?php } ?>
                                                </div>  
                                            </td>
                                            <td><?php echo $pharmacy['medicine_company']; ?></td>
                                            <td><?php echo $pharmacy['medicine_composition']; ?></td>
                                            <td><?php echo $pharmacy['medicine_category']; ?></td>
                                            <td><?php echo $pharmacy['medicine_group']; ?></td>
                                            <td><?php echo $pharmacy['unit']; ?></td>
                                            <td><?php echo $pharmacy['total_qty'] . $status; ?></td> 
                                        </tr>
                                        <?php
                                        $count++;
                                    }
                            ...
                            <div class="col-lg-11 col-md-10 col-sm-8 table-responsive">
                                <table class="table mb0 table-striped table-bordered examples">
                                    ...
                                    <tr>                                  <th></th>
                                        ...
                                        <td width="35%"><span id='vat'></span></td>

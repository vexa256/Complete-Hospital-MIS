...
<div class="content-wrapper">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if (!empty($diagnosis_value["document"])) { ?>
                                                                    <a class="btn btn-default btn-xs" href="<?php echo base_url() . "admin/patient/report_download/" . $diagnosis_value["document"] ?>" ><i class="fa fa-download"></i></a>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="timeline-item">
                                                                ...
                                                                <?php if (!empty($value["document"])) { ?>
                                                                    <span class="time"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "patient/dashboard/download_staff_timeline/" . $value["id"] . "/" . $value["document"] ?>" data-original-title="Download"><i class="fa fa-download"></i></a></span>
                                                                <?php } ?>
                                                ...
                                                if (!empty($prescription_detail)) {
                                                    foreach ($prescription_detail as $prescription_key => $prescription_value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="pull-right"><a href="#" data-toggle='modal' onclick="view_prescription('<?php echo $prescription_value["id"]; ?>', '<?php echo $prescription_value["opd_id"]; ?>')"><i class="fa fa-reorder"></i></a></th>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
                                                    ...
                                                    <form method="post" id="add_bill"  enctype="multipart/form-data">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable fontbold20"><input type="hidden" readonly name="net_amount" value="<?php
                                                                                                              ...
                                                                                                              ?>" id="net_amount" style="width: 30%;float: right" class="form-control"><span><?php
                                                if (!empty($result["net_amount"])) {
                                                    echo $result["net_amount"];
                                                } else {
                                                    echo $total - $paid_amount;
    ...
    if (!empty($payment_method)) {
        ...
        <?php if ($result["is_active"] == 'yes') { ?>
                                                <button type="button" class="btn btn-info" data-result_id="<?php echo $result['id'] ?>" data-toggle="modal" data-target="#payMoney"><i class="fa fa-plus"></i> <?php echo $this->lang->line('make_payment'); ?></button>
        <?php } ?>
        <?php
    }
    ?>

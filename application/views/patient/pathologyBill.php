                                    ...
                                    foreach ($result as $detail) {
                                        ...
                                        ?> </td>
                                            ...
                                            <td class="text-right"><?php
                                                ...
                                                ?></td>
                                            <td>  <a href="#" onclick="viewDetail('<?php echo $detail->id ?>')" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('print') . " " . $this->lang->line('report'); ?>">

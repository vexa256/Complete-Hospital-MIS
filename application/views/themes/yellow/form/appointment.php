...
<form class="form appointment" action="<?php echo site_url('form/appointment') ?>" method="POST">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ?>">
                <label for="date"><?php echo $this->lang->line('patient') . " " . $this->lang->line('id') . " "; ?></label>
                <input type="text" class="form-control" onchange="getpatientDetails()" id="patient_id" name="patient_id">
            </div>
        </div><!--./col-md-6-->
        <div class="col-md-6">
            ...
            ?>">
                ...
                <div class='input-group' >
                    <input type='text' class="form-control" id='datetimepicker' readonly name="date" value="<?php echo set_value('date') ?>"  />
        ...
        <div class="col-md-6">  
            ...
            ?>">
                ...
                <input type="hidden" name="addpatient_id" id="addpatient_id">
            </div>
        </div>  
        <div class="col-md-6">
            <div class="form-group <?php
            ...
            ?>">
                ...
                <select name="doctor" class="form-control select2" <?php echo set_select('doctor', set_value('doctor')) ?> >
        ...
        <div class="col-md-6">
            ...
            ?>">
                ...
                <textarea class="form-control" id="pwd" name="message"  placeholder="<?php echo $this->lang->line('enter') . " " . $this->lang->line('message') ?>"></textarea>
            </div>
        </div>  
        <div class="col-md-12">
            <div class="form-group">

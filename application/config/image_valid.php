...
$config['file_validate'] = array(
    'allowed_mime_type' => array('application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'), //mime_type
    'allowed_extension' => array('pdf', 'doc', 'docx', 'xls', 'xlsx'), // image extensions
    'upload_size' => 1048576, // bytes
);

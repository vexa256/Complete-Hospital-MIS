...
class Medicinecategory extends Admin_Controller {
    ...
    public function addsupplier() {
        if ((!$this->rbac->hasPrivilege('supplier_category', 'can_add')) || (!$this->rbac->hasPrivilege('supplier_category', 'can_edit'))) {
            access_denied();
        }
    ...
    public function deletesupplier($id) {
        if (!$this->rbac->hasPrivilege('supplier_category', 'can_delete')) {
            access_denied();
        }

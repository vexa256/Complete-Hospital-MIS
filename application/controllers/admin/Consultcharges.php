...
class Consultcharges extends Admin_Controller {
    ...
    public function addconsultcharges() {
        if (!$this->rbac->hasPrivilege('doctor_consultcharges', 'can_add')) {
            access_denied();
        }
    ...
    public function get_charge_category() {
        if (!$this->rbac->hasPrivilege('doctor_consultcharges', 'can_view')) {
            access_denied();
        }
        $charge_type = $this->input->post("charge_type");
    ...
    public function delete($id) {
        if (!$this->rbac->hasPrivilege('doctor_charge', 'can_delete')) {
            access_denied();
        }
    ...
    public function update_charges() {
        if (!$this->rbac->hasPrivilege('doctor_consultcharges', 'can_edit')) {
            access_denied();
        }
